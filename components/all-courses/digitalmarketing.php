	...
	<div class="container-fluid">
		<div class="row mt-3 justify-content-around">
			...
			<div class="col-sm-7 col-md-7">
				...
				<p>A digital marketing course educates individuals on leveraging online platforms for promoting products and services. It covers diverse topics such as social media strategies, search engine optimization, content creation, email campaigns, and data analytics. This learning equips participants with essential skills to engage target audiences effectively, enhance brand visibility, and achieve business objectives in the digital realm.</p>
				<hr>
		...
		<div class="row details mt-5 justify-content-center align-content-center position-relative">
			<div class="col-sm-10 col-md-7 bg-white  details1 p-5">
				...
				<p>
A digital marketing course is a comprehensive learning experience that equips participants with essential skills to navigate the dynamic online landscape. It covers a wide spectrum of strategies, including social media marketing, search engine optimization (SEO), content creation, email campaigns, and data analysis. By mastering these techniques, individuals gain the ability to strategically engage target audiences, enhance brand recognition, drive website traffic, and maximize online conversions.

In today's competitive business landscape, digital marketing expertise is crucial for businesses to effectively leverage digital channels, achieve higher visibility, and remain ahead of the curve. This training empowers marketers to create impactful campaigns, accurately measure results, and adapt strategies based on real-time insights. Ultimately, a digital marketing course is a valuable investment for professionals and businesses seeking to harness the power of online platforms for sustainable growth and success.</p>
			</div>
		...
		<div class="row description  justify-content-center  position-relative">
			<div class="col-sm-10 col-md-7 bg-white">
				...
				<div class="mt-4">
					<li>Perfect for individuals across various domains aspiring for professional advancement.</li>
					<li>Software developers and IT professionals looking to transition into the realm of digital marketing can greatly benefit.</li>
					...
					<li>Executives from a wide array of profit and not-for-profit sectors can leverage the insights offered by this program to enhance their knowledge and expertise.</li>
				</div>
				<div class="row mt-5">
					<div class="col">
			...
			<div class="col-sm-10 col-md-4 bg-white p-5">
				...
				<ol>
					...
					<li>Social - Insta, FB, YT, E-com website, Google</li>
					<li>Conversion Rate Optimization (CRO)</li>
					<li>Mobile Marketing</li>
					<li>Inbound Marketing</li>
					<li>Web Analytics</li>
					<li>Online Advertisation</li>
				</ol>
			</div>
		</div>
