	...
	<div class="container-fluid">
		<div class="row mt-3 justify-content-around">
			...
			<div class="col-sm-7 col-md-7">
				...
				<p>
					The Plumbing Course structured educational or training program designed to equip students with the theoretical knowledge and practical skills necessary for the installation, maintenance, repair, and design of plumbing systems, which includes water supply, drainage, and sanitary systems within residential, commercial, industrial, and public buildings. Our course also cover topics like safety protocols, reading blueprints, understanding plumbing codes and regulations, and the use of various tools and equipment specific to the plumbing trade.
		...
		<div class="row details mt-5 justify-content-center align-content-center position-relative">
			<div class="col-sm-10 col-md-7 bg-white  details1 p-5">
				...
				<p>
            The plumbing course provides comprehensive training on the installation, maintenance, and repair of plumbing systems to the students. Students learn the intricacies of water supply, drainage, and sanitation in various structures, from homes to industrial facilities. The course covers key concepts like plumbing codes, blueprint reading, and safety protocols, ensuring participants are equipped with both theoretical knowledge and hands-on experience. Designed for aspiring plumbers and those seeking to enhance their skills, the course paves the way for potential certification or licensure in the plumbing trade, a prerequisite in many regions to practice professionally.</p>
		...
		<div class="row description  justify-content-center  position-relative">
			<div class="col-sm-10 col-md-7 bg-white">
				...
				<div class="mt-4">
					<li><strong>Beginners/High School Graduates:</strong>ndividuals fresh out of high school or those with no prior plumbing experience can delve into foundational courses. Vocational schools and community colleges often provide entry-level programs tailored for this group, emphasizing basic techniques, safety protocols, and introductory knowledge, laying the groundwork for a potential plumbing career
					</li>

    				<li><strong>Existing Tradespeople:</strong> Workers already involved in related sectors like construction, electrical, or HVAC can expand their skill set by taking up plumbing courses. By doing so, they can diversify their expertise, undertake a wider range of projects, and become more versatile in the construction industry. </li>

   					<li><strong>Current Plumbers:</strong> Seasoned plumbers  can often enroll in advanced courses to specialize in niche areas or to stay abreast of the latest technologies and regulations. This could include studies in areas like gas fitting, water treatment, or modern sustainable plumbing solutions. Continuous learning ensures they remain competitive and updated in their trade</li>


    				<li><strong>Entrepreneurs:</strong> Visionaries aiming to launch their own plumbing business. The course lays the foundation, ensuring they  know-how to serve customers efficiently, building credibility and trust.</li>
				</div>
				<div class="row mt-5">
					<div class="col">
						<small>ELIGIBILITY</small>
						<hr style="width: 10%;">
						<div class="mt-4 mb-4">Open to all students. No experience required, and no plumbing background is needed to thrive in this course.</div>
