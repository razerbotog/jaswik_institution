	...
	<div class="container-fluid">
		<div class="row mt-3 justify-content-around">
			...
			<div class="col-sm-7 col-md-7">
				<h1 class="text-center">PERSONALITY DEVELOPMENT</h1>
				<p>Elevate your personal and professional life through our Personality Development course. Cultivate essential skills such as effective communication, self-confidence, and interpersonal finesse. Navigate challenges with poise and build a foundation for success in diverse social and work settings.</p>
				<hr>
		...
		<div class="row details mt-5 justify-content-center align-content-center position-relative">
			<div class="col-sm-10 col-md-7 bg-white  details1 p-5">
				...
				<p>Embark on a transformative journey of self-discovery with our Personality Development course. Cultivate vital skills that go beyond appearances, enhancing your communication finesse, self-confidence, and emotional intelligence. Navigate interpersonal dynamics with grace, from active listening to empathetic interactions. Strengthen your ability to tackle challenges, building resilience and determination. Whether in personal relationships or professional endeavors, this course empowers you to radiate self-assuredness and establish meaningful connections. As you refine your personality, you're poised to unlock doors to success and growth, enriching your holistic development journey.</p>
			</div>
		...
		<div class="row description  justify-content-center  position-relative">
			<div class="col-sm-10 col-md-7 bg-white">
				...
				<div class="mt-4">
				<li><strong>Unveil Your Potential:</strong> Ideal for those seeking personal growth, this course fosters holistic personality development.</li>
    <li><strong>Self-Discovery:</strong> Dive into self-awareness, identifying strengths, weaknesses, and opportunities for personal enhancement.</li>
    <li><strong>Effective Communication:</strong> Develop communication finesse, enhancing your interactions, relationships, and professional presence.</li>
    <li><strong>Confidence Boost:</strong> Cultivate self-assuredness, positive self-esteem, and resilience, navigating life's challenges with poise.</li>
    <li><strong>Interpersonal Skills:</strong> Master soft skills, empathy, and active listening, fostering meaningful connections in various settings.</li>
    <li><strong>Goal Achievement:</strong> Set and pursue personal and professional goals with a newfound sense of purpose and determination.</li>
				</div>
				<div class="row mt-5">
					<div class="col">
