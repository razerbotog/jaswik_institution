	...
	<div class="container-fluid">
		<div class="row mt-3 justify-content-around">
			...
			<div class="col-sm-7 col-md-7">
				<h1 class="text-center">SELF GROOMING & CONFIDENCE DEVELOPMENT</h1>
				<p>Empower yourself through our Self Grooming & Confidence Development course. Learn grooming techniques and strategies to enhance your appearance and self-image. Build self-assurance and inner strength, radiating confidence in every aspect of your life.</p>
				<hr>
		...
		<div class="row details mt-5 justify-content-center align-content-center position-relative">
			<div class="col-sm-10 col-md-7 bg-white  details1 p-5">
				...
				<p> Embark on a transformative journey of self-discovery and empowerment with our Self Grooming & Confidence Development course. Unlock the secrets of personal grooming, from skincare to presentation skills, allowing your inner beauty to shine through. Cultivate unwavering self-assurance, enhancing your self-esteem and resilience. This course nurtures your holistic growth, helping you radiate confidence in personal, social, and professional spheres. Embrace a newfound sense of empowerment that transcends appearances and exudes from within, transforming your life journey.</p>
			</div>
		...
		<div class="row description  justify-content-center  position-relative">
			<div class="col-sm-10 col-md-7 bg-white">
				...
				<li><strong>Enhance Personal Presentation:</strong> Ideal for individuals looking to refine their appearance and project a positive self-image through grooming techniques.</li>
    <li><strong>Inner Confidence Cultivation:</strong> Beyond appearances, this course empowers you to develop unshakable inner confidence, boosting self-esteem and resilience.</li>
    <li><strong>Comprehensive Grooming Skills:</strong> Learn skincare, personal hygiene, and presentation strategies to radiate confidence in every aspect of your life.</li>
    <li><strong>Holistic Transformation:</strong> Unveil a more empowered version of yourself, exuding self-assuredness in personal, social, and professional contexts.</li>
				</div>
				<div class="row mt-5">
					<div class="col">
