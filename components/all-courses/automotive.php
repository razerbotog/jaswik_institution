	...
	<div class="container-fluid">
		<div class="row mt-3 justify-content-around">
			...
			<div class="col-sm-7 col-md-7">
				<h1 class="text-center">AUTOMOTIVE REPAIRING</h1>
				
				<p>
					The Automotive Repairing Course is a structured program of study that provides students with the theoretical knowledge and practical skills necessary to diagnose, service, and repair motor vehicles. Our course covers various aspects of automobile mechanics and electronics, including engine systems, drivetrain, chassis, electrical systems, diagnostics, and troubleshooting. By the end of the course, students are  capable of addressing and resolving common mechanical and electrical issues found in vehicles, understanding maintenance protocols, and effectively utilizing automotive repair tools and equipment. 
				</p>
				<hr>
		...
		<div class="row details mt-5 justify-content-center align-content-center position-relative">
			<div class="col-sm-10 col-md-7 bg-white  details1 p-5">
				...
				<p>
                The Automotive Repairing Course provides comprehensive training and knowledge to individuals interested in becoming skilled automotive technicians or mechanics. This course covers a wide range of topics related to vehicle maintenance, diagnostics, and repair. Participants gain practical skills through hands-on training and theoretical understanding of various automotive systems.The Course is designed to equip students with the expertise needed to identify, diagnose, and rectify mechanical and electronic issues in motor vehicles. It focuses on both theory and practical application, enabling participants to excel in the dynamic field of automotive maintenance and repair.</p>
		...
		<div class="row description  justify-content-center  position-relative">
			<div class="col-sm-10 col-md-7 bg-white">
				...
				<div class="mt-4">
					<li><strong>Aspiring Mechanics and Technicians:</strong>Individuals who have a strong inclination towards the automotive sector and aspire to establish their careers as certified automotive mechanics or technicians.Young adults seeking skilled training right after high school can shape their career as an automotive engineer by enrolling in our course.</li>

    				<li><strong>High School Graduatess:</strong> Graduates who are exploring hands-on, skills-based career paths and have an aptitude for mechanical tasks and problem-solving can master this course.</li>

   					<li><strong>Automotive Enthusiasts and Hobbyists:</strong>People who are passionate about cars and vehicles, wanting to understand their inner workings.DIY individuals wishing to perform maintenance and minor repairs on their vehicles.</li>


    				<li><strong>Entrepreneurs:</strong> Individuals planning to open automotive repair shops, service centers, or related businesses.Existing garage owners wanting formal training to enhance their service offerings.</li>
				</div>
				<div class="row mt-5">
					<div class="col">
