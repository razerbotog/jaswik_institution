	...
	<div class="container-fluid">
		<div class="row mt-3 justify-content-around">
			...
			<div class="col-sm-7 col-md-7">
				...
				<p>A web development course empowers individuals with the skills needed to create dynamic and responsive websites. Covering HTML, CSS, JavaScript, and more, participants learn to design user-friendly interfaces, optimize website performance, and implement interactive features. This training equips learners to craft engaging online experiences, bolster user engagement, and excel in the ever-evolving landscape of web technology.</p>
				<hr>
		...
		<div class="row details mt-5 justify-content-center align-content-center position-relative">
			<div class="col-sm-10 col-md-7 bg-white  details1 p-5">
				...
				<p>A web development course offers a comprehensive learning journey, equipping participants with essential skills to navigate the dynamic online landscape. Encompassing HTML, CSS, JavaScript, and frameworks, it empowers individuals to craft engaging and responsive websites. With mastery of these tools, learners can optimize site performance, create seamless user experiences, and implement interactive functionalities. In the digital age, a strong web presence is crucial, making web development expertise invaluable for individuals and businesses seeking to excel online. This training empowers professionals to thrive in the ever-evolving digital realm, creating impressive online platforms that stand out in a competitive landscape.</p>
			</div>
			<div class="col-sm-10 col-md-4 keyHighlights p-4">
				...
				<small><i class="fa-solid fa-certificate"></i>100% Job Assistance</small>
		...
		<div class="row description  justify-content-center  position-relative">
			<div class="col-sm-10 col-md-7 bg-white">
				...
				<div class="mt-4">
					<li>Ideal for beginners and professionals from diverse backgrounds aspiring to excel in web development.</li>
    <li>Software developers seeking to enhance their skillset and explore the world of dynamic web creation will benefit greatly.</li>
    <li>Students and individuals passionate about building responsive websites and interactive user interfaces will find immense value.</li>
    <li>Entrepreneurs aiming to establish a strong online presence can leverage web development skills to create engaging platforms.</li>
				</div>
				<div class="row mt-5">
					<div class="col">
