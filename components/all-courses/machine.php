	...
	<div class="container-fluid">
		<div class="row mt-3 justify-content-around">
			...
			<div class="col-sm-7 col-md-7">
				<h1 class="text-center">MICROWAVE & WASHING MACHINE</h1>
				
				<p>
					The Microwave and Washing Machine Course is specialized training program designed to educate students about the principles, operation, and repair techniques of microwaves and washing machines. Our course covers the fundamental concepts of appliance electronics, diagnostics, safety protocols, and hands-on practice for troubleshooting and maintenance. By the end of the program, students are expected to possess the knowledge and skills required to diagnose common problems, perform repairs, and maintain  appliances efficiently. 
				</p>
				<hr>
		...
		<div class="row details mt-5 justify-content-center align-content-center position-relative">
			<div class="col-sm-10 col-md-7 bg-white  details1 p-5">
				...
				<p>
                Our Microwave and Washing Machine Course typically aims to teach participants the knowledge and skills required to repair and maintain the common household appliances.
                 Microwaves: Magnetrons, microwave radiation, turntables, and their applications.
				 Machines : Types (front load, top load), basic mechanics, wash cycles, etc.Understanding circuits, power supply, motors, and control systems in microwaves and washing machines. </p>
		...
		<div class="row description  justify-content-center  position-relative">
			<div class="col-sm-10 col-md-7 bg-white">
				...
				<div class="mt-4">
					<li><strong>Aspiring Appliance Repair Technicians:</strong> Those aiming to build a career in appliance maintenance and repair can benefit immensely from our course.</li>

    				<li><strong>Electronics Students:</strong>  Students enrolled in electronics or related engineering course can expand their practical knowledge by learning about real-world applications in household appliances by enrolling in our course.</li>

   					<li><strong>DIY Enthusiasts:</strong> Individuals passionate about repairing and maintaining their own household items can gain useful insights and skills and master the course.</li>

    				<li><strong>Entrepreneurs:</strong> Those considering opening their own appliance repair business or services can use our course as a foundation to build upon.</li>
				</div>
				<div class="row mt-5">
					<div class="col">
						<small>ELIGIBILITY</small>
						<hr style="width: 10%;">
						<div class="mt-4 mb-4">Open to all students. No experience required, and no technical background is needed to thrive in this course.</div>
