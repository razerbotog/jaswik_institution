	...
	<div class="container-fluid">
		<div class="row mt-3 justify-content-around">
			...
			<div class="col-sm-7 col-md-7">
				<h1 class="text-center">MOBILE REPAIRING</h1>
				
				<p>
					A Mobile Repairing Course is a structured program of study that equips participants with the necessary knowledge and hands-on skills to diagnose, troubleshoot, and repair various issues in mobile phones and other handheld electronic devices. The course delves into both hardware and software aspects of mobile devices, addressing topics such as component identification, circuit analysis, soldering techniques, software installation, and fault diagnosis. Upon completion, participants should be proficient in addressing common technical problems, replacing damaged parts, and ensuring the optimal functioning of mobile devices. 
				</p>
				<hr>
		...
		<div class="row details mt-5 justify-content-center align-content-center position-relative">
			<div class="col-sm-10 col-md-7 bg-white  details1 p-5">
				...
				<p>
              The Mobile Repairing Course equips students with the skills to diagnose, troubleshoot, and repair smartphones and related devices.There's a growing need for skilled technicians to handle technical issues, both hardware and software-related.Our course introduces participants to the fundamentals of mobile technologies, diving deep into the internal components of smartphones. Students learn about tools used, basic electronics, and mobile OS intricacies. Hands-on training on hardware issues like screen replacements and software troubleshooting, including OS updates, are central. Emphasis on safety, latest industry trends, and effective diagnostics ensures participants emerge as competent mobile repair technicians.</p>
		...
		<div class="row description  justify-content-center  position-relative">
			<div class="col-sm-10 col-md-7 bg-white">
				...
				<div class="mt-4">
					<li><strong>Aspiring Technicians:</strong> Students passionate about technology, aiming to carve a future in the mobile repairing sector. This course provides a gateway to a lucrative career, catering to the ever-increasing demand for skilled technicians as mobile devices remain indispensable in our daily lives.</li>

    				<li><strong>Electronics Students:</strong> Students, whether in high school or higher education, studying electronics, IT, or related disciplines. Enrolling enhances their practical skills, offering a balance between academic learning and hands-on expertise, making them industry-ready.Curious minds wanting to delve into the intricacies of their own devices. </li>

   					<li><strong>Mobile Retailers:</strong> Individuals involved in the sale of mobile phones. Gaining repair skills augments their understanding of products, fostering trust with customers through informed advice and potential after-sales support.</li>


    				<li><strong>Entrepreneurs:</strong> Visionaries aiming to launch their own mobile repair business. The course lays the foundation, ensuring they possess the technical know-how to serve customers efficiently, building credibility and trust.</li>
				</div>
				<div class="row mt-5">
					<div class="col">
						<small>ELIGIBILITY</small>
						<hr style="width: 10%;">
						<div class="mt-4 mb-4">Open to all students. No experience required, and no automobile background is needed to thrive in this course.</div>
