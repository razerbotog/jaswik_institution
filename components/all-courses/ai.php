	...
	<div class="container-fluid">
		<div class="row mt-3 justify-content-around">
			...
			<div class="col-sm-7 col-md-7">
				...
				<p>An Artificial Intelligence (AI) course empowers individuals to harness the potential of advanced technologies for solving complex problems and driving innovation. This comprehensive course delves into a wide range of topics, including machine learning algorithms, natural language processing, computer vision, robotics, and neural networks. Participants will gain hands-on experience in designing AI models, programming intelligent agents, and exploring cutting-edge AI applications.</p>
				<hr>
		...
		<div class="row details mt-5 justify-content-center align-content-center position-relative">
			<div class="col-sm-10 col-md-7 bg-white  details1 p-5">
				...
				<p>
                The Artificial Intelligence (AI) course provides a comprehensive exploration of AI concepts and their real-world applications. This course delves into the intricacies of machine learning algorithms, neural networks, natural language processing, and robotics. Participants will acquire hands-on experience in designing, training, and implementing AI models. By immersing themselves in this course, individuals will gain the skills necessary to creatively apply AI to solve complex problems across various domains. From enhancing medical diagnoses to optimizing business operations, this course equips participants with the knowledge and practical expertise to navigate the rapidly evolving AI landscape. Graduates of the AI course will be well-prepared to contribute to innovative projects, leveraging AI's potential to revolutionize industries and drive meaningful advancements.</p>
			</div>
		...
		<div class="row description  justify-content-center  position-relative">
			<div class="col-sm-10 col-md-7 bg-white">
				...
				<div class="mt-4">
				<li>Ideal for individuals from diverse backgrounds seeking professional growth opportunities.</li>
                <li>Tailored for software developers and IT professionals seeking to pivot into the field of AI.</li>
                <li>Professors aiming to upgrade their skill set to encompass digital marketing techniques will find this course invaluable.</li>
                <li>Highly valuable for educators and professors aiming to upskill in AI techniques for enhanced teaching and research capabilities.</li>
				</div>
				<div class="row mt-5">
					<div class="col">
			...
			<div class="col-sm-10 col-md-4 bg-white p-5">
				...
				<hr>
				<ol>
				<li>Machine Learning fundamentals and applications</li>
				<li>Neural networks and deep learning architectures</li>
				<li>Natural Language Processing (NLP) techniques</li>
				<li>Computer vision and image recognition</li>
				<li>Reinforcement learning for AI-driven decision-making</li>
				<li>Ethical considerations in AI development</li>
				<li>AI in business automation and optimization</li>
				<li>AI-driven data analysis and predictive modeling</li>
				<li>Hands-on projects and real-world case studies</li>
				<li>Collaborative AI development and team projects</li>
				<li>Industry insights and guest lectures from AI experts</li>
				<li>Practical coding exercises in Python and relevant frameworks</li>
				<li>AI ethics and responsible AI practices</li>
				<li>Stay updated with the latest AI trends and innovations</li>
				<li>Personalized guidance and mentorship from experienced AI professionals</li>
				</ol>
			</div>
		</div>
