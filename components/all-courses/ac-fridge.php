	...
	<div class="container-fluid">
		<div class="row mt-3 justify-content-around">
			...
			<div class="col-sm-7 col-md-7">
				<h1 class="text-center">AC & REFRIGERATION REPAIRING</h1>
				
				<p>
					A structured educational program designed to equip students with the knowledge, skills, and techniques required to diagnose, repair, and maintain air conditioning and refrigeration systems. The course covers the fundamental principles of thermodynamics, the components of AC and refrigeration systems, the use and handling of refrigerants, electrical aspects of the systems, and safety protocols, ensuring that graduates can effectively address malfunctions and ensure the optimal performance of A/C & REFRIGERATION systems.
				</p>
				<hr>
		...
		<div class="row details mt-5 justify-content-center align-content-center position-relative">
			<div class="col-sm-10 col-md-7 bg-white  details1 p-5">
				...
				<p>AC and Refrigeration Repairing Course typically covers topics like basic refrigeration principles, HVAC system components, electrical systems, refrigerant handling, troubleshooting, and safety protocols. Students  learn about compressor operation, evaporator and condenser coils, leak detection, and practical repair skills. Our curriculum often includes hands-on training and also delve into energy efficiency and environmental regulations related to refrigerants.</p>
			</div>
		...
		<div class="row description  justify-content-center  position-relative">
			<div class="col-sm-10 col-md-7 bg-white">
				...
				<div class="mt-4">
					<li><strong>Beginners/High School Graduates:</strong> Individuals looking to start a career in HVAC&R (Heating, Ventilation, Air Conditioning, and Refrigeration) without prior experience.</li>
    				<li><strong>Vocational Training Students:</strong>Students in technical colleges or institutions looking to specialize in a hands-on field and aiming for a certification to kick-start their career in HVAC&R.</li>
   					<li><strong>Existing HVAC&R Technicians:</strong> Professionals already in the field wanting to upgrade their skills and seeking to gain knowledge about the latest technologies or methods in the industry.</li>
    				<li><strong>Entrepreneurs:</strong> Individuals looking to start a business in AC and refrigeration services and wanting a foundational knowledge of the field.</li>
				</div>
				<div class="row mt-5">
					<div class="col">
						<small>ELIGIBILITY</small>
						<hr style="width: 10%;">
						<div class="mt-4 mb-4">Open to all students. No experience required, and no skill background is needed to thrive in this course.</div>
