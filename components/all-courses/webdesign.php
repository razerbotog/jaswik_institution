	...
	<div class="container-fluid">
		<div class="row mt-3 justify-content-around">
			...
			<div class="col-sm-7 col-md-7">
				...
				<p>Explore the realm of web design in this module. Discover design principles, typography, color theory, and layout techniques that form the foundation of visually appealing websites. Learn to create engaging user interfaces, optimize user experiences, and master the art of responsive and mobile-friendly design. Unleash your creativity and shape captivating online visuals that leave a lasting impact.</p>
				<hr>
		...
		<div class="row description  justify-content-center  position-relative">
			<div class="col-sm-10 col-md-7 bg-white">
				...
				<div class="mt-4">
					<li><strong>Ideal for Beginners and Professionals:</strong> Tailored for individuals with varying levels of expertise, this course is designed to accommodate both beginners and professionals aiming to excel in the field of web development.</li>
    				<li><strong>Software Developers:</strong> This course is especially beneficial for software developers looking to expand their skillset and delve into the realm of dynamic web creation. It equips them with the knowledge and tools needed to create interactive and user-friendly websites.</li>
   					<li><strong>Passionate Students:</strong> Students and individuals enthusiastic about crafting responsive websites and designing engaging user interfaces will find this course invaluable. It provides them with the fundamental skills to bring their creative visions to life.</li>
    				<li><strong>Entrepreneurs:</strong> Entrepreneurs seeking to establish a robust online presence can leverage the power of web development. This course empowers them to create captivating platforms that resonate with their target audience, enhancing user engagement and brand visibility.</li>
				</div>
				<div class="row mt-5">
					<div class="col">
