	...
	<div class="container-fluid">
		<div class="row mt-3 justify-content-around">
			<div class="col-sm-7 col-md-5">
				<div class="card position-relative mt-3">
						<img src="../vocational-courseimg/MUSIC.jpg" class="img-fluid">
						<span class="cat-meta">
		                   Vocational
		                 </span>
					</div>
			...
			<div class="col-sm-7 col-md-7">
				...
				<p>Explore the realm of music with our Music course. Learn fundamental concepts, musical notation, and instrument proficiency. Develop your musical skills and appreciation, paving the way for creative expression and potential performance opportunities.</p>
				<hr>
		...
		<div class="row details mt-5 justify-content-center align-content-center position-relative">
			<div class="col-sm-10 col-md-7 bg-white  details1 p-5">
				...
				<p>Dive into the enchanting world of music through our comprehensive Music course. Uncover the intricate language of music, from deciphering musical notation to mastering a chosen instrument. Develop your musical talents, whether through vocal techniques or instrumental prowess, opening doors to solo performances or collaborative projects. Immerse yourself in diverse genres, exploring the history and evolution of musical artistry. By understanding music's power to evoke emotions and tell stories, you embark on a journey of creative expression, enriching your life with the joy of melodies and harmonies.</p>
			</div>
		...
		<div class="row description  justify-content-center  position-relative">
			<div class="col-sm-10 col-md-7 bg-white">
				...
				<div class="mt-4">
				<li><strong>Discover the World of Music:</strong> Tailored for music enthusiasts, this course offers a comprehensive introduction to musical concepts and skills.</li>
    <li><strong>Music Fundamentals:</strong> Learn musical notation, rhythm, melody, and harmony, laying the groundwork for musical expression.</li>
    <li><strong>Instrument Proficiency:</strong> Master playing a musical instrument of your choice, gaining hands-on skills in musical performance.</li>
    <li><strong>Vocal Techniques:</strong> Develop your singing prowess, exploring vocal techniques, range, and expression for dynamic performances.</li>
    <li><strong>Music Appreciation:</strong> Dive into the history and genres of music, enhancing your understanding and appreciation of musical artistry.</li>
    <li><strong>Performance Opportunities:</strong> Showcase your musical talents and potentially open doors to collaborations, events, and musical projects.</li>
				</div>
				<div class="row mt-5">
					<div class="col">
