	...
	<div class="container-fluid">
		<div class="row mt-3 justify-content-around">
			...
			<div class="col-sm-7 col-md-7">
				<h1 class="text-center">Communication & Soft Skills</h1>
				<p>Elevate your personal and professional interactions with our Communication & Soft Skills course. Develop effective communication, active listening, and interpersonal finesse. Navigate diverse social and work settings with confidence, building connections and fostering positive relationships.</p>
				<hr>
		...
		<div class="row details mt-5 justify-content-center align-content-center position-relative">
			<div class="col-sm-10 col-md-7 bg-white  details1 p-5">
				...
				<p>Unveil the art of impactful communication and interpersonal finesse through our comprehensive Communication & Soft Skills course. From mastering verbal and nonverbal communication to cultivating active listening and empathy, this program equips you for success in personal and professional interactions. Strengthen your presentation skills, negotiation abilities, and conflict resolution techniques. Navigate challenges with poise and build meaningful connections that transcend boundaries. Whether forging lasting relationships, collaborating in team environments, or advancing in your career, these skills are your key to unlocking opportunities and enriching your social landscape with genuine connections.</p>
			</div>
		...
		<div class="row description  justify-content-center  position-relative">
			<div class="col-sm-10 col-md-7 bg-white">
				...
				<div class="mt-4">
				<li><strong>Ideal for Enhancing Communication:</strong> Tailored for all seeking improved communication and interpersonal skills, this course helps individuals thrive in various personal and professional settings.</li>
    <li><strong>Soft Skills Mastery:</strong> Develop essential soft skills including active listening, empathy, and effective collaboration, vital for success in today's interconnected world.</li>
    <li><strong>Confidence Building:</strong> Cultivate self-assurance and confidence in social interactions, presentations, and conversations, empowering you to communicate with impact.</li>
    <li><strong>Career Advancement:</strong> Whether seeking career growth or personal development, this course equips you with the skills to navigate diverse communication scenarios.</li>
				</div>
				<div class="row mt-5">
					<div class="col">
