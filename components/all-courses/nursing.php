	...
	<div class="container-fluid">
		<div class="row mt-3 justify-content-around">
			...
			<div class="col-sm-7 col-md-7">
				<h1 class="text-center">NURSING</h1>
		...
		<div class="row details mt-5 justify-content-center align-content-center position-relative">
			<div class="col-sm-10 col-md-7 bg-white  details1 p-5">
				...
				<p>Unveil the path to healthcare excellence through our Nursing course. From foundational medical concepts to hands-on clinical skills, this program equips you with essential knowledge for a nursing career. Delve into anatomy, physiology, and medical ethics while developing expertise in patient care, medication administration, and wound dressing. Cultivate compassionate bedside manner and effective communication to navigate the healthcare environment with empathy. This course not only prepares you for entry-level nursing positions but also sets the stage for advanced medical education and specialization, shaping your journey towards making a meaningful impact in patient care.</p>
			</div>
		...
		<div class="row description  justify-content-center  position-relative">
			<div class="col-sm-10 col-md-7 bg-white">
				...
				<div class="mt-4">
				<li><strong>Begin Your Nursing Journey:</strong> Tailored for aspiring nurses, this course offers fundamental knowledge and skills for a nursing career.</li>
    <li><strong>Medical Fundamentals:</strong> Learn anatomy, physiology, and medical terminology, forming a strong foundation for nursing practice.</li>
    <li><strong>Clinical Skills:</strong> Develop hands-on nursing skills, from patient care and medication administration to wound dressing.</li>
    <li><strong>Empathetic Care:</strong> Cultivate compassionate patient care, communication, and bedside manner, essential for nursing excellence.</li>
    <li><strong>Medical Ethics:</strong> Understand ethical considerations in healthcare, ensuring you uphold professional standards in all aspects of nursing.</li>
    <li><strong>Path to Healthcare:</strong> Launch your nursing career or use this course as a stepping stone for further medical education and specialization.</li>
				</div>
				<div class="row mt-5">
					<div class="col">
