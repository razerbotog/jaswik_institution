	...
	<div class="container-fluid">
		<div class="row mt-3 justify-content-around">
			...
			<div class="col-sm-7 col-md-7">
				<h1 class="text-center">HAIR STYLIST</h1>
				<p> Embrace the art of hairstyling with our Hair Stylist course. Learn cutting-edge techniques in hair cutting, coloring, and styling. Develop the skills to craft trendy hair transformations and present yourself as a confident professional in the beauty industry.</p>
				<hr>
		...
		<div class="row details mt-5 justify-content-center align-content-center position-relative">
			<div class="col-sm-10 col-md-7 bg-white  details1 p-5">
				...
				<p>Step into the dynamic world of beauty and fashion with our Hair Stylist course. From mastering the latest hair trends and coloring techniques to honing the art of hair cutting and styling, this program provides a comprehensive foundation for aspiring hairstylists. Develop an eye for detail and client consultation skills, understanding individual preferences and needs. Immerse yourself in the realm of salon management, customer service, and industry insights, setting the stage for a successful career in the beauty industry. Whether transforming clients' looks or participating in creative projects, you'll be equipped to create stunning hair transformations and leave a lasting impression.</p>
			</div>
		...
		<div class="row description  justify-content-center  position-relative">
			<div class="col-sm-10 col-md-7 bg-white">
				...
				<div class="mt-4">
				<li><strong>Pursue Your Hair Styling Passion:</strong> Designed for aspiring hair stylists, this course provides a comprehensive foundation in hairstyling techniques.</li>
    <li><strong>Hairstyling Essentials:</strong> Learn hair cutting, coloring, and styling techniques, mastering the art of creating diverse looks.</li>
    <li><strong>Trendy Hair Trends:</strong> Stay current with the latest hair trends and techniques, offering clients modern and stylish hair transformations.</li>
    <li><strong>Client Consultation:</strong> Develop communication skills for effective client consultations, understanding their preferences and needs.</li>
    <li><strong>Salon Business Basics:</strong> Gain insights into salon management, customer service, and building a successful hairstyling career.</li>
    <li><strong>Path to Hair Industry:</strong> Launch your hairstyling career or use this course as a foundation for further specialization in hair design and beauty.</li>
