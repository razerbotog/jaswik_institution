	...
	<div class="container-fluid">
		<div class="row mt-3 justify-content-around">
			...
			<div class="col-sm-7 col-md-7">
				<h1 class="text-center">Purchase Strategies</h1>
				<p>
The Purchase Master Course empowers participants with vital procurement skills, encompassing supplier communication, negotiation strategies, and utilization of procurement technologies. Individuals develop proficiency in vendor relationship management, cost-effective sourcing, and effective use of procurement software. Whether newcomers or experienced professionals, this all-inclusive program fosters success in the ever-evolving procurement domain, nurturing competence and leadership in the business landscape.</p>
				<hr>
		...
		<div class="row details mt-5 justify-content-center align-content-center position-relative">
			<div class="col-sm-10 col-md-7 bg-white  details1 p-5">
				...
				<p>The Purchase Master Course empowers participants with essential procurement skills, including effective supplier communication, strategic negotiation tactics, and the utilization of cutting-edge procurement technologies. Individuals develop expertise in vendor relationship management, cost-efficient sourcing strategies, and proficient use of procurement software. Whether participants are newcomers seeking to establish a foundation or seasoned professionals aiming to enhance their capabilities, this comprehensive program cultivates success in the dynamic realm of procurement. By fostering competence and leadership in the evolving business landscape, the Purchase Master Course equips individuals to excel in procurement and drive value for their organizations.</p>
			</div>
		...
		<div class="row description  justify-content-center  position-relative">
			<div class="col-sm-10 col-md-7 bg-white">
				...
				<div class="mt-4">
				<li>Ideal for newcomers and experienced professionals aiming to thrive in the field of procurement management.</li>
<li>Procurement practitioners seeking to expand their expertise and explore dynamic supply chain strategies will greatly benefit.</li>
<li>Students and individuals enthusiastic about effective sourcing and vendor management will discover significant value.</li>
<li>Entrepreneurs aiming to optimize their business's procurement processes can acquire skills to establish efficient supply chains.</li>
<li>Professionals from diverse sectors looking to enhance their proficiency in procurement strategies, negotiation tactics, and supplier relationship management will find this course invaluable.</li>
				</div>
				<div class="row mt-5">
					<div class="col">
						<small>ELIGIBILITY</small>
						<hr style="width: 10%;">
						<div class="mt-4">The Purchase Master Course welcomes individuals from various educational backgrounds, catering to newcomers and seasoned practitioners passionate about excelling in procurement management. It offers accessibility regardless of prior experience, ensuring all participants with a drive to succeed in the field can thrive.</div>
					</div>
					<div class="col">
			...
			<div class="col-sm-10 col-md-4 bg-white p-5">
				...
				<hr>
				<ol>
					<li>Intro to Purchase Strategies </li>
					<li>Procurement</li>
					...
					<li>Legal Aspects of Purchasing</li>
