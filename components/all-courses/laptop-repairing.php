	...
	<div class="container-fluid">
		<div class="row mt-3 justify-content-around">
			...
			<div class="col-sm-7 col-md-7">
				<h1 class="text-center">LAPTOP REPAIRING</h1>
				
				<p>
					 A structured program of study that imparts knowledge and skills related to diagnosing, troubleshooting, and repairing laptop computers. This course typically covers various aspects of laptop hardware and software, including component identification, assembly and disassembly procedures, understanding operating system issues, driver installations, and solutions to common problems. 
				</p>
				<hr>
		...
		<div class="row details mt-5 justify-content-center align-content-center position-relative">
			<div class="col-sm-10 col-md-7 bg-white  details1 p-5">
				...
				<p>
                Our laptop repairing course is a specialized training program designed to educate students about the ins and outs of laptop hardware and software troubleshooting and repairs.Detailed study of laptop components including the motherboard, CPU, RAM, hard drive, display, keyboard, battery, and other peripherals.: Practical sessions on how to assemble and disassemble laptops, understanding component placements, and best practices to avoid damage. </p>
		...
		<div class="row description  justify-content-center  position-relative">
			<div class="col-sm-10 col-md-7 bg-white">
				...
				<div class="mt-4">
					<li><strong>IT Students:</strong> Tailored for individuals with varying levels of expertise, this course is designed to accommodate students aiming to excel in the field of Laptop Repairing.</li>
    				<li><strong>Professionals:</strong> IT professionals or technicians looking to expand their skills or specialize in laptop repair.</li>
   					<li><strong>Freelancers:</strong>Freelancers who wish to offer tech support or repair services can take this course to enhance their offerings to clients.</li>
    				<li><strong>Aspiring Technicians:</strong> Individuals who wish to pursue a career in computer hardware maintenance, repair, and technical support.</li>
				</div>
				<div class="row mt-5">
					<div class="col">
						<small>ELIGIBILITY</small>
						<hr style="width: 10%;">
						<div class="mt-4 mb-4">Open to students with basic knowledge of laptop repairing. No experience required, and no networking background is needed to thrive in this course.</div>
